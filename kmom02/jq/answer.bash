...
#
# 743eed92d103063e93f065811e054e7c
# webapp
# jq
# v1
# ussa19
...
# v4.0.0 (2019-03-05)
#
# Generated 2020-04-16 21:52:14 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
ANSWER=$(jq '.data[].comments.data[0] | select(.from.username == "alkifaey").text' tag-dbwebb.json)
